                                ...
                                <td class="p-2">
                                    <div class="flex justify-center items-center gap-2">
                                        ...
                                        <form action="{{ route('codecategory.destroy', $category) }}" method="POST">
                                            ...
                                            @method('DELETE')
                                            <button onclick="return confirm('Are you sure you want to delete the category: {{ $category->name }}?')" title="Delete">
