<div>
    ...
    <form wire:submit="save">
        ...
        <div class="mx-auto w-11/12">
            ...
            <div class="relative">
                <input wire:model="title" name="title" id="title" type="text" value="{{ $entry->title }}"
                    maxlength="255"
            ...
            <div class="flex">
                ...
                <select wire:model.live="selectedTags" name="selectedTags" id="selectedTags" multiple
                    ...
                    @foreach ($tags as $tag)
                        <option value="{{ $tag->id }}"
                            @foreach ($selectedTags as $selectedTag) @if ($tag->id == $selectedTag) selected class="bg-orange-500 text-white" @endif @endforeach>
                            {{ $tag->name }}</option>
                    @endforeach
                </select>
            </div>
