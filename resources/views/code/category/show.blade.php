        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            ...
            <div class="mx-auto w-11/12 py-4 px-2">
                ...
                <div class="flex flex-row justify-start items-center gap-4 py-2">
                    <!-- Name -->
                    <input type="text" id="name" class="bg-zinc-200 border border-zinc-300 text-gray-900 text-md rounded-lg w-full sm:w-1/2 pl-2 p-2  dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500" value="{{ $category->name }}" disabled>
                    <!-- Edit -->
                    <a href="{{ route('codecategory.edit', $category) }}">
                        <i class="fa-solid fa-pen-to-square text-green-600 hover:text-black transition duration-1000 ease-in-out" title="Edit"></i>
                    </a>
                    <!-- Delete -->
                    <form action="{{ route('codecategory.destroy', $category) }}" method="POST">
