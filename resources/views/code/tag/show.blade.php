...
<x-app-layout>
    <div class="max-w-7xl mx-auto sm:pb-8 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-row justify-start items-start gap-1 text-sm py-3 px-4 text-slate-500">
            ...
            <a href="/dashboard/tag/{{ $tag->id }}" class="font-bold text-black border-b-2 border-b-orange-600">Info</a>
        </div>
            ...
            <div class="mx-auto w-11/12 py-4 px-2">
                ...
                <div class="flex flex-row justify-start items-center gap-4 py-2">
                    ...
                    <form action="{{ route('codetag.destroy', $tag) }}" method="POST">
                        ...
                        @method('DELETE')
                        <button onclick="return confirm('Are you sure you want to delete the tag: {{ $tag->name }}?')">
